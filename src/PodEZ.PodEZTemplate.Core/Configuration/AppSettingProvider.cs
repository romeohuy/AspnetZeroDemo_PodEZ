...
namespace PodEZ.PodEZTemplate.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!PodEZTemplateConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings, GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings, PodEZTemplateConsts.MultiTenancyEnabled? "true":"false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ PodEZTemplateDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ PodEZTemplateDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = PodEZTemplateDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = PodEZTemplateDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.GeneralStats, // General Stats
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.ProfitShare, // Profit Share
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Memeber Activity
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.RegionalStats, // Regional Stats
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 5
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.DailySales, // Daily Sales
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.TopStats, // Top Stats
                                    Height = 5,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.SalesSummary, // Sales Summary
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 5
                ...
                new Dashboard
                {
                    DashboardName = PodEZTemplateDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Host.TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Host.IncomeStatistics, // Income Statistics
                                    Height = 11,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 6
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 10,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants, // Subscription expiring tenants
                                    Height = 10,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Host.EditionStatistics, // Edition statistics
                                    Height = 11,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 6
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                new Widget
                                {
                                    WidgetId = PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Member Activity
                                    Height = 11,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 24
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                {
                                    WidgetId =
                                        PodEZTemplateDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 9,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 12
