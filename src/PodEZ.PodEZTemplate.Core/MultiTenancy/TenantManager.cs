...
using PodEZ.PodEZTemplate.MultiTenancy.Demo;
...
namespace PodEZ.PodEZTemplate.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(PodEZTemplateConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(PodEZTemplateConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
