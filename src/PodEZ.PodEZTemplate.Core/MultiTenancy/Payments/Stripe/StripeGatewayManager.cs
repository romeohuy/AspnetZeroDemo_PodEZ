...
{
    public class StripeGatewayManager : PodEZTemplateServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "PodEZTemplate";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PodEZTemplateConsts.Currency;
        }
