...
namespace PodEZ.PodEZTemplate.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PodEZTemplateServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PodEZ.PodEZTemplate", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
