...
using PodEZ.PodEZTemplate.Authorization.Ldap;
...
using PodEZ.PodEZTemplate.DashboardCustomization.Definitions;
using PodEZ.PodEZTemplate.Debugging;
using PodEZ.PodEZTemplate.DynamicEntityParameters;
using PodEZ.PodEZTemplate.Features;
...
using PodEZ.PodEZTemplate.Net.Emailing;
using PodEZ.PodEZTemplate.Notifications;
using PodEZ.PodEZTemplate.WebHooks;

namespace PodEZ.PodEZTemplate
{
    [DependsOn(
        typeof(PodEZTemplateCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class PodEZTemplateCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            PodEZTemplateLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = PodEZTemplateConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, PodEZTemplateMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<PodEZTemplateSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PodEZTemplateCoreModule).GetAssembly());
        }
