...
using PodEZ.PodEZTemplate.Web.Public.Startup;
using PodEZ.PodEZTemplate.Web.Session;

namespace PodEZ.PodEZTemplate.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PodEZTemplateViewComponent
    {
