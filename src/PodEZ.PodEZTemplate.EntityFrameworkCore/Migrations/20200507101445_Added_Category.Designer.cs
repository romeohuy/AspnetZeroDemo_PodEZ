...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PodEZ.PodEZTemplate.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PodEZ.PodEZTemplate.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PodEZ.PodEZTemplate.PodEZ.Entity.PozOrderDemo.PozOrderDemo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<decimal>("PozImageTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("PozOrderDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PozOrderName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("PozOrderDemo");
                });

            modelBuilder.Entity("PodEZ.PodEZTemplate.PodEz.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PodEZ.PodEZTemplate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PodEZ.PodEZTemplate.Authorization.Users.User", null)
                        .WithMany("Claims")
