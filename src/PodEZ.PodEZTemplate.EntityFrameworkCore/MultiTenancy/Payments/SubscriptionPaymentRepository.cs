...
{
    public class SubscriptionPaymentRepository : PodEZTemplateRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PodEZTemplateDbContext> dbContextProvider)
