...
using PodEZ.PodEZTemplate.EntityFrameworkCore.Repositories;

namespace PodEZ.PodEZTemplate.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PodEZTemplateRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PodEZTemplateDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
