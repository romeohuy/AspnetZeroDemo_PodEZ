...
using PodEZ.PodEZTemplate.Authentication.TwoFactor.Google;
using PodEZ.PodEZTemplate.Authorization.Users.Dto;
using PodEZ.PodEZTemplate.Authorization.Users.Profile.Cache;
using PodEZ.PodEZTemplate.Authorization.Users.Profile.Dto;
using PodEZ.PodEZTemplate.Friendships;
using PodEZ.PodEZTemplate.Gdpr;
using PodEZ.PodEZTemplate.Identity;
using PodEZ.PodEZTemplate.Net.Sms;
using PodEZ.PodEZTemplate.Security;
using PodEZ.PodEZTemplate.Storage;
using PodEZ.PodEZTemplate.Timing;

namespace PodEZ.PodEZTemplate.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PodEZTemplateAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PodEZ.PodEZTemplate",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("PodEZ.PodEZTemplate",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
