...
using PodEZ.PodEZTemplate.Auditing.Exporting;
...
using EntityHistoryHelper = PodEZ.PodEZTemplate.EntityHistory.EntityHistoryHelper;

namespace PodEZ.PodEZTemplate.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PodEZTemplateAppServiceBase, IAuditLogAppService
    {
