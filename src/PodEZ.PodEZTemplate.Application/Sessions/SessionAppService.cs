...
{
    public class SessionAppService : PodEZTemplateAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = PodEZTemplateConsts.Currency,
                    CurrencySign = PodEZTemplateConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = PodEZTemplateConsts.AllowTenantsToChangeEmailSettings,
