...
namespace PodEZ.PodEZTemplate.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PodEZTemplateAppServiceBase, IDashboardCustomizationAppService
    {
