...
using PodEZ.PodEZTemplate.Migrations.Seed.Host;
...
namespace PodEZ.PodEZTemplate.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PodEZTemplateAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PodEZTemplateDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(PodEZTemplateConsts.ConnectionStringName).Value.ToString();
        }
