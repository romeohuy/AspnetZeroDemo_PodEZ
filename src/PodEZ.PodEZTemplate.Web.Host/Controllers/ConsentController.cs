...
using PodEZ.PodEZTemplate.Web.Models.Consent;

namespace PodEZ.PodEZTemplate.Web.Host.Controllers
{
    public class ConsentController : PodEZTemplateControllerBase
    {
