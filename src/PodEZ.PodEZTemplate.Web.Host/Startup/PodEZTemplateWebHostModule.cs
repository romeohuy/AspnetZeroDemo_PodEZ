...
namespace PodEZ.PodEZTemplate.Web.Startup
{
    ...
    public class PodEZTemplateWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PodEZTemplateWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PodEZTemplateWebHostModule).GetAssembly());
        }
