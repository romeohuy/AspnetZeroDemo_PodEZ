...
namespace PodEZ.PodEZTemplate.Core.Base
{
    public abstract class PodEZTemplateQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected PodEZTemplateQueryBase(string fieldName,
