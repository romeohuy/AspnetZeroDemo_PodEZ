...
namespace PodEZ.PodEZTemplate.Web.Areas.App.Views.Shared.Components.AppTheme6Footer
{
    public class AppTheme6FooterViewComponent : PodEZTemplateViewComponent
    {
