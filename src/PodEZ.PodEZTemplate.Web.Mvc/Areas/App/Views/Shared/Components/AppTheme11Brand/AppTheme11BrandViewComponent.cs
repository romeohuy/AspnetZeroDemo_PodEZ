...
namespace PodEZ.PodEZTemplate.Web.Areas.App.Views.Shared.Components.AppTheme11Brand
{
    public class AppTheme11BrandViewComponent : PodEZTemplateViewComponent
    {
