...
using PodEZ.PodEZTemplate.Web.Areas.App.Models.Languages;
...
namespace PodEZ.PodEZTemplate.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : PodEZTemplateControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = PodEZTemplateConsts.LocalizationSourceName;
            }
