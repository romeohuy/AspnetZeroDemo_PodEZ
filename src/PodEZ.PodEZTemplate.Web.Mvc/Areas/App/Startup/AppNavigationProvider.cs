...
namespace PodEZ.PodEZTemplate.Web.Areas.App.Startup
{
    public class AppNavigationProvider : NavigationProvider
    {
        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            ...
            menu
                .AddItem(new MenuItemDefinition(
                        ...
                        icon: "flaticon-more",
                        permissionDependency: new SimplePermissionDependency(AppPermissions.Pages_PozOrderDemo)
                    )
                ).AddItem(new MenuItemDefinition(
        ...
        {
            return new LocalizableString(name, PodEZTemplateConsts.LocalizationSourceName);
        }
    }
}
