...
namespace PodEZ.PodEZTemplate.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class PodEZTemplateScriptSrcTagHelper : TagHelper
    {
        ...
        public PodEZTemplateScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
