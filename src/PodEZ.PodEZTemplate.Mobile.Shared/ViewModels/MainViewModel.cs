...
using MvvmHelpers;
using PodEZ.PodEZTemplate.Authorization.Users.Profile;
...
using PodEZ.PodEZTemplate.Services.Navigation;
...
using PodEZ.PodEZTemplate.Controls;
using PodEZ.PodEZTemplate.Dto;
using PodEZ.PodEZTemplate.Extensions;
using PodEZ.PodEZTemplate.Localization;
using PodEZ.PodEZTemplate.UI;
using PodEZ.PodEZTemplate.UI.Assets;
using PodEZ.PodEZTemplate.Views;
using DependencyResolver = PodEZ.PodEZTemplate.Core.Dependency.DependencyResolver;
...
namespace PodEZ.PodEZTemplate.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PodEZTemplate";
