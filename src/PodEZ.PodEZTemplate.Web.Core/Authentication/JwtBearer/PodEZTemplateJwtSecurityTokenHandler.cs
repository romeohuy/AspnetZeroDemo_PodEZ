...
namespace PodEZ.PodEZTemplate.Web.Authentication.JwtBearer
{
    public class PodEZTemplateJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public PodEZTemplateJwtSecurityTokenHandler()
        {
