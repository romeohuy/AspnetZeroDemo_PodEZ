...
using PodEZ.PodEZTemplate.Web.Authentication.JwtBearer;
using PodEZ.PodEZTemplate.Web.Authentication.TwoFactor;
using PodEZ.PodEZTemplate.Web.Chat.SignalR;
using PodEZ.PodEZTemplate.Web.Configuration;
using PodEZ.PodEZTemplate.Web.DashboardCustomization;

namespace PodEZ.PodEZTemplate.Web
{
    [DependsOn(
        typeof(PodEZTemplateApplicationModule),
        typeof(PodEZTemplateEntityFrameworkCoreModule),
    ...
    public class PodEZTemplateWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PodEZTemplateWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PodEZTemplateApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PodEZTemplateWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(PodEZTemplateWebCoreModule).Assembly);
        }
