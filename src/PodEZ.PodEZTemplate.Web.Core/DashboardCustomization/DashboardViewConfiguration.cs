...
namespace PodEZ.PodEZTemplate.Web.DashboardCustomization
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(PodEZTemplateDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
